...
public class AnimatedVectorDrawableCompat {
    ...
    public static void addListener(AnimatedVectorDrawable drawable, Object callback) {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if(callback instanceof Animatable2.AnimationCallback) {
                ...
                throw new IllegalArgumentException("Callback parameter must implement " +
                        Animatable2.AnimationCallback.class.getName());
            }
        }
    }
    ...
    public static void start(Animator animator, AnimatedVectorDrawable drawable) {
        Message msg = Message.obtain(sHandler, AnimatedVectorDrawableHandler.MSG_START,
                new Object[]{animator, drawable});
    ...
    public static void stop(Animator animator, AnimatedVectorDrawable drawable) {
        Message msg = Message.obtain(sHandler, AnimatedVectorDrawableHandler.MSG_STOP,
                new Object[]{animator, drawable});
            ...
            switch (msg.what) {
                case MSG_START:
                    ...
                    if(Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                        ...
                        Message msgStop = Message.obtain(sHandler, AnimatedVectorDrawableHandler.MSG_STOP,
                                new Object[]{animator, drawable});
