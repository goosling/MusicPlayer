...
public class AnimatedVectorDrawableWrapper extends Animator {
    ...
    public AnimatedVectorDrawableWrapper(AnimatedVectorDrawable mAnimatedVectorDrawable) {
        this.mAnimatedVectorDrawable = mAnimatedVectorDrawable;
    ...
    private static class AnimatorListenerWrapperM extends Animatable2.AnimationCallback implements AnimatorListenerWrapper {
        ...
        public AnimatorListenerWrapperM(Animator mAnimator, AnimatorListener mListener) {
