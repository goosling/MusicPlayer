...
public class CoverView extends ImageView implements Animatable{
    ...
    public static final int TACK_ALPHA_OPAQUE = 1;
    ...
    public CoverView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStartAnimator = ObjectAnimator.ofFloat(this, View.ROTATION,
                0, FULL_ANGLE);
        ...
        mStartAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationCancel(Animator animation) {
                ...
                mEndAnimator = ObjectAnimator.ofFloat(CoverView.this, View.ROTATION,
                        current, target);
